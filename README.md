...
| 研究代码：三条验证线 | **第一阶段实现完成**——W1 Hebbian 感知 MNIST **98.01%** ✓；W2 e-prop 序列 sMNIST **77.48%**（活跃神经元 1.0000）✓；W3 R-STDP CartPole **未达标**（阈值 ≥ 200 步）。数字与复现记录见[复现记录](docs/reproducibility.md) |
