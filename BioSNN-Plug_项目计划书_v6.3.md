...
**任务**：音频插件接入；R-STDP + TD-LTP Critic [Frémaux et al., 2013]；仲裁器扩展至三规则冲突维度（第 1–3 类）[Confavreux et al., 2025]；持续学习基准（CIFAR-100-B0 10 步增量，参考 PS-SNN 的 76.42%）[Hu et al., 2026]。
