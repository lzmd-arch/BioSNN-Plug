...
| W2 e-prop 認知層 | [`research/eprop/README.ja.md`](../research/eprop/README.ja.md) | sMNIST 77.48%；活動ニューロン比率 1.0000（閾値 > 60%）。**傍証 SHD は負の結果**：テスト精度 0.0534 ≈ 偶然水準（0.05）——sMNIST 用のハイパーパラメータでは SHD を学習しません。診断と今後の進め方は README 参照 |
