...
以下问题属于 **`BioSNN-Plug_项目计划书_v6.2.md` 正文**，本文件改不了它。**2026-09-23：这些更正已全部并入 [`BioSNN-Plug_项目计划书_v6.3.md`](../BioSNN-Plug_项目计划书_v6.3.md)**——本表保留作为改动记录，**引用计划书时请用 v6.3**。
